...
const Dashboard = props => {
  ...
  //meta title
  document.title = "Dashboard | reactdash";
    ...
    <React.Fragment>
      <div className="page-content">
            ...
            <Card className="mini-stats-wid">
              <CardBody>
                <div className="d-flex flex-wrap">
                  <div className="me-3">
                    <p className="text-muted mb-2">Total Companies</p>
          ...
          <Col lg={4}>
            <Card className="blog-stats-wid">
              <CardBody>
                <div className="d-flex flex-wrap">
                  <div className="me-3">
                    <p className="text-muted mb-2">Total Stores</p>
        ...
        <Card style={{ }} >
          <CardBody>
            <div className="d-flex flex-wrap">
              <h5 className="card-title me-2">Margin Profit</h5>
        ...
        <Card>
          <CardBody>
            <h4 className="card-title mb-4">Status Projects</h4>
            ...
            <div className="text-center text-muted">
              <Row>
                <Col xs="4">
                  <div className="mt-4">
                    <p className="mb-2 ">
                      <i className="mdi mdi-circle text-primary me-1" /> Completed
                ...
                <Col xs="4">
                  <div className="mt-4">
                    <p className="mb-2 ">
                      <i className="mdi mdi-circle text-success me-1" /> Approved
                ...
                <Col xs="4">
                  <div className="mt-4">
                    <p className="mb-2 ">
                      <i className="mdi mdi-circle text-danger me-1" /> Delayed
                    ...
                    <h5>2</h5>
                        ...
                        //       <label>Seja Bem Vindo Ao Sistema reactdash!</label>
                        //     </div>
                        //   </div>
                        //   <div className="row">
